package com.backend.uberclone.config;

import com.backend.uberclone.security.auth.RestAuthenticationEntryPoint;
import com.backend.uberclone.security.auth.TokenAuthenticationFilter;
import com.backend.uberclone.service.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/location/**").permitAll()	// /h2-console/** ako se koristi H2 baza)
